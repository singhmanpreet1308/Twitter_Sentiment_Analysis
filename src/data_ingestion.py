...
def load_data(data_url:str) -> pd.DataFrame:
    try:
        ...
        print(f"ErrorL Failed to parse the CSV file from {data_url}.")
        print(e)
        raise
...
def main():
    try:
        df = load_data(data_url='https://raw.githubusercontent.com/singhmanpreet1308/Twitter_Sentiment_Analysis/refs/heads/main/tweet_emotions.csv')
